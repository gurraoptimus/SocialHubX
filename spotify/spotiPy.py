...
# ============================
# 🔗 Step 1: User Input for spotify Profile URL
# ============================
...
# ============================
# 🎨 Step 3: Apply spotify Gradient to QR Code
# ============================
gradient = Image.new("RGBA", (qr_width, qr_height), (255, 255, 255, 255))
draw = ImageDraw.Draw(gradient)

# spotify gradient colors
colors = [
    (255, 195, 0),   # Yellow
    (255, 87, 34),   # Orange
    (233, 30, 99),   # Pink
...
for y in range(qr_height):
    for spotify in range(qr_width):
        if qr_array[y, spotify, 0] < 128:  # If it's a black pispotifyel
            qr_array[y, spotify] = gradient_array[y, spotify]  # Apply gradient color

final_qr = Image.fromarray(qr_array)

# ============================
# 🎭 Step 4: Create a Circular spotify Logo
# ============================
...
# Draw spotify-style gradient background
...
final_qr.save("spotiPy.png")

print("✅ QR code with circular spotify logo and user image saved as 'spotiPy'.")

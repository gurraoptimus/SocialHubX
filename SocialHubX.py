...
# ============================
# 🔗 Step 1: User Input for SocialHubX Profile URL
# ============================
...
socialhubx_url = f"https://www.github.com/topics{topics}/"
...
# ============================
# 🎨 Step 3: Apply SocialHubX Gradient to QR Code
# ============================
gradient = Image.new("RGBA", (qr_width, qr_height), (255, 255, 255, 255))
draw = ImageDraw.Draw(gradient)

# SocialHubX gradient colors
colors = [
    (255, 195, 0),   # Yellow
    (255, 87, 34),   # Orange
    (233, 30, 99),   # Pink
...
# ============================
# 🎭 Step 4: Create a Circular SocialHubX Logo
# ============================
...
# Draw SocialHubX-style gradient background
...
# ============================
user_img_url = f"https://repository-images.githubusercontent.com/952452402/31a99a4d-ef9d-4789-9cc4-b1b2cb4a0522"# User provides the URL
...
try:
    ...
    print("Using only SocialHubX logo.")
...
print("✅ QR code with circular SocialHubX logo and user image saved as 'SocialHubX QR Code'.")

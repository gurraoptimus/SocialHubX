...
# ============================
# 🔗 Step 1: User Input for coddy Profile URL
# ============================
...
# ============================
# 🎭 Step 4: Create a Circular coddy Logo
# ============================
...
# Draw coddy-style gradient background
...
# ============================
user_img_url = f"https://coddy.tech/favicon.ico"  # User provides the URL
...
print("✅ QR code with circular coddy logo and user image saved as 'SocialHubX QR Code'.")

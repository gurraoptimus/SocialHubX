...
# ============================
# 🔗 Step 1: User Input for KakaoTalk Profile URL
# ============================
#kakaotalk_username = "kakaotalk"
kakaotalk_username = input("Enter your KakaoTalk username: ")  # User can input their KakaoTalk username
kakaotalk_url = f"https://pf.kakao.com/{kakaotalk_username}/"
...
# ============================
# 🎨 Step 3: Apply KakaoTalk Gradient to QR Code
# ============================
gradient = Image.new("RGBA", (qr_width, qr_height), (255, 255, 255, 255))
draw = ImageDraw.Draw(gradient)

# KakaoTalk gradient colors
colors = [
    (255, 195, 0),   # Yellow
    (255, 87, 34),   # Orange
    (233, 30, 99),   # Pink
...
# ============================
# 🎭 Step 4: Create a Circular KakaoTalk Logo
# ============================
...
# Draw KakaoTalk-style gradient background
...
# ============================
user_img_url = f"https://scontent-arn2-1.cdnkakaotalk.com/v/t51.2885-19/281440578_1088265838702675_6233856337905829714_n.jpg?_nc_ht=scontent-arn2-1.cdnkakaotalk.com&_nc_cat=1&_nc_oc=Q6cZ2QHHE-ZLT_T8jgBBUfxV7nPsE8eFO1zZIwDH_UozmDI8bt41XH4x5wm4WfQMxUp2kaw&_nc_ohc=wd0IuiyrqDEQ7kNvgHkMxbw&_nc_gid=WY0Ord4Sk8rB6wgsQ6rFig&edm=APs17CUBAAAA&ccb=7-5&oh=00_AYGG3b_X87VB5mxoYhO41KMQxIn-mA00TDhdk1NjQHjRGQ&oe=67E1D998&_nc_sid=10d13b"  # User provides the URL
...
try:
    ...
    print("Using only KakaoTalk logo.")
...
print("✅ QR code with circular KakaoTalk logo and user image saved as 'SocialHubX QR Code'.")

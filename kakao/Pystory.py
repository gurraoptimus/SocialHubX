...
# ============================
# 🔗 Step 1: User Input for KakaoStory Profile URL
# ============================
...
kakaostory_url = f"https://www.kakaostory.com/@{kakaostory_username}/"
...
# ============================
# 🎨 Step 3: Apply KakaoStory Gradient to QR Code
# ============================
gradient = Image.new("RGBA", (qr_width, qr_height), (255, 255, 255, 255))
draw = ImageDraw.Draw(gradient)

# KakaoStory gradient colors
colors = [
    (255, 195, 0),   # Yellow
    (255, 87, 34),   # Orange
    (233, 30, 99),   # Pink
...
# ============================
# 🎭 Step 4: Create a Circular KakaoStory Logo
# ============================
...
# Draw KakaoStory-style gradient background
...
# ============================
user_img_url = f"https://t1.kakaocdn.net/kakaocorp/kakaocorp/admin/service/2abdfc18018700001.png"  # User provides the URL
...
try:
    ...
    print("Using only KakaoStory logo.")
...
print("✅ QR code with circular KakaoStory logo and user image saved as 'SocialHubX QR Code'.")
